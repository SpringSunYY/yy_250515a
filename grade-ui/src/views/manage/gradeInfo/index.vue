  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="gradeInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="成绩编号" align="center" v-if="columns[0].visible" prop="gradeId" />
        <el-table-column label="课程名称" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="courseId" />
        <el-table-column label="学生成绩" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="score" />
        <el-table-column label="成绩描述" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="gradeDesc" />
